...
\section*{Code}
\begin{tabular}{L!{\VRule}R}
  +3 years & Python, Bash, git \& R   \\
  1-2 years & nextflow, HTML, SQL \& \LaTeX
\end{tabular}
...
2018 & \bibentry{mas-ponte2018} - {\em \color{black!70} Peer-reviewed Conference - Poster} \\
&\bibentry{Flores-Bello:2018aa} - {\em \color{black!70} Peer-reviewed Journal}\\
2017&\bibentry{mas2017lncatlas} - {\em \color{black!70} Peer-reviewed Journal}\\[5pt]
& \bibentry{carlevaro2017unique} - {\em \color{black!70} Preprint (under review)}\\[5pt]
