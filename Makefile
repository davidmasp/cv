...
assets/bskylogo.svg:
	mkdir -p assets
	wget -O $@ https://upload.wikimedia.org/wikipedia/commons/7/7a/Bluesky_Logo.svg
...
cv.pdf: cv.typ dmas.yaml talks.yaml assets/twitterlogo.svg assets/bskylogo.svg assets/github-mark.svg
	typst compile $<
